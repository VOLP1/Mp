        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              ...
              <p className="text-green-700 font-bold">Preço: R$ 99,99</p>
              <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-4">Adicionar ao Carrinho</button>
            </div>
