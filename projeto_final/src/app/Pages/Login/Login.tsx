                ...
                <div className=" bg-white shadow-xl w-1/3 h-2/3 mb-16 mt-20 flex flex-col rounded-2xl border-0.1 border-black ">
                    ...
                    <form className="justify-center mx-16" >
                        <div className=" flex flex-col h-fit w-full  space-y-10 justify-center ">
                            <input type="email" placeholder = 'EMAIL' className = 'border-0.1 border-black rounded-3xl h-10 text-center' />
                            <input type="password" placeholder = 'SENHA' className='border-0.1 border-black rounded-3xl h-10 text-center' />
                        </div>
